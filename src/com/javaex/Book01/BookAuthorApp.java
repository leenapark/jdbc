...
public class BookAuthorApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * //작가 등록 6명 //AuthorDao, AuthorVo 이용해서 등록 AuthorVo authorVo1 = new
		 * AuthorVo("이문열", "경북 양양"); authorDao.authorInsert(authorVo1);
		 * 
		...
		/*
		 * //책 등록 //BookDao, BookVo 이용해서 등록 //(수정, 삭제, 리스트) BookVo bookVo1 = new
		 * BookVo("우리들의 일그러진 영웅", "다림", "1998/02/22", 1); bookDao.bookInsert(bookVo1);
		 * 
		...
		List<BookVo> searchList = bookDao.getsearch(str);

		System.out.println(str);

		for (int i = 0; i < searchList.size(); i++) {
			//BookVo bookVo = searchList.get(i);
